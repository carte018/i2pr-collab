...
java -Xms128m -Xmx128m -Djava.security.egd=file:///dev/urandom -DXL.HomeDir=$OIM_COMMON_HOME/conf/oim -Djava.security.auth.login.config=$OIM_COMMON_HOME/conf/oim/config/authwl.conf edu.duke.oit.idms.oracle.prov_tasks.RetryProvTasks $1;
